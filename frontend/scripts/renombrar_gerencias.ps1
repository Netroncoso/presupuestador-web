# Renombrar gerencias en frontend
Write-Host "Renombrando gerencias en frontend..." -ForegroundColor Yellow
...
if (Test-Path "frontend\src\pages\GerenciaAdministrativaDashboard.tsx") {
    Rename-Item "frontend\src\pages\GerenciaAdministrativaDashboard.tsx" "GerenciaPrestacionalDashboard_NEW.tsx"
}

if (Test-Path "frontend\src\pages\GerenciaPrestacionalDashboard.tsx") {
    Rename-Item "frontend\src\pages\GerenciaPrestacionalDashboard.tsx" "GerenciaComercialDashboard.tsx"
}

if (Test-Path "frontend\src\pages\GerenciaPrestacionalDashboard_NEW.tsx") {
    Rename-Item "frontend\src\pages\GerenciaPrestacionalDashboard_NEW.tsx" "GerenciaPrestacionalDashboard.tsx"
}
